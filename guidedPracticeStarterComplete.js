...
const getPokemon = async() => {
 ...
 const pokemonHTML = pokemonArray.map((pokemon) => {
  ...
  //  addBtnInteraction(detailsBtn); //add this line in at the end of the demo, right before the return to have see what happens 
   return card;
  })
  ...
  */
  ...
  // 9. once we are satisfied with our mapped cards and they are all rendering to the screen properly, let's comment out that render line and continue with another api call. ********
